...
```mermaid
flowchart LR
    A["Choose folder"] --> B["Local scanner"]
    B --> C["File tree snapshot"]
    C --> D["Recursive treemap layout"]
    D --> E["Native CoreGraphics canvas"]
    E --> F["Inspect, Quick Look, Reveal, Copy Path"]
```
